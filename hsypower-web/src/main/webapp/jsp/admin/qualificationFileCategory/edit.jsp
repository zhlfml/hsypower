...
<body>
	<center>
	<form:form commandName="qualificationFileCategory" enctype="multipart/form-data">
	    <form:hidden path="id" />
		...
		<table class="pn-ftable" width="100%" cellspacing="1" cellpadding="2" border="0">
			<tbody>
				...
				<tr style="height: 110px">
					<td class="pn-flabel pn-flabel-h" width="10%">资质文件类图:</td>
					<td class="pn-fcontent" width="25%"><form:input path="file" type="file" /></td>
					<td class="pn-fcontent" width="65%" colspan="2"><img id="preview" src="${ctx }${qualificationFileCategory.filePath }" height="100px" /></td>
				</tr>
			</tbody>
		</table>
